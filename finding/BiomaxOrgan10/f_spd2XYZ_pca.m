...
function [XYZ, CovXYZ] = f_spd2XYZ_pca(sig_m, sig_s, ls, b_s, b_f)
    ...
    x_bar = repmat(cmf(b_s:b_f,2),1,input_n);
    y_bar = repmat(cmf(b_s:b_f,3),1,input_n);
    z_bar = repmat(cmf(b_s:b_f,4),1,input_n);
